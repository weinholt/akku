...
(library (akku metadata)
  ...
  (define main-package-version '"1.1.0-beta.0")
  (define installed-libraries
    '((akku config) (akku format lockfile) (akku format manifest)
      ...
      (pffi variable) (private install sipp) (scheme base)
      (scheme case-lambda) (scheme char) (scheme complex)
      (scheme cxr) (scheme eval) (scheme file) (scheme inexact)
      (scheme lazy) (scheme load) (scheme process-context)
      (scheme r5rs) (scheme read) (scheme repl) (scheme time)
      (scheme write) (semver compat match) (semver ranges)
      ...
      (srfi :111) (srfi :111 boxes) (srfi :113)
      (srfi :113 sets-and-bags) (srfi :115) (srfi :115 regexp)
      (srfi :115 regexp boundary) (srfi :116 ilists) (srfi :117)
      (srfi :117 list-queues) (srfi :125) (srfi :125 hashtables)
      (srfi :126) (srfi :126 helpers helpers)
      (srfi :126 r6rs-hashtables) (srfi :127)
      ...
      (struct pack) (wak fmt) (wak fmt c) (wak fmt color)
