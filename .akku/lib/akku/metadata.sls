...
(library (akku metadata)
  ...
  (define main-package-version '"0.3.0-alpha.0")
  (define installed-libraries
    '((akku format lockfile) (akku format manifest)
      ...
      (compression zlib) (example grid) (example life)
      (hashing crc) (hashing fixnums) (hashing hmac) (hashing md5)
      (hashing private common) (hashing private compat)
      (hashing sha-1) (hashing sha-2) (industria base64)
      ...
      (industria crypto ec) (industria crypto ecdsa)
      ...
      (industria ssh kexdh) (industria ssh private)
      (industria ssh public-keys) (industria ssh random-art)
      (industria ssh transport) (industria ssh userauth)
      (industria strings) (industria tcp) (ip-address)
      (laesare reader) (packrat) (semver ranges) (semver versions)
      (spdx ids) (spdx parser) (spells algebraic-types)
      ...
      (srfi :115) (srfi :115 boundary) (srfi :115 regexp)
      ...
      (srfi private registry) (srfi private vanish) (struct pack)
