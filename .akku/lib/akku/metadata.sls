...
(library (akku metadata)
  ...
  (define main-package-version '"0.3.2-alpha.0")
  (define installed-libraries
    '((akku format lockfile) (akku format manifest)
      ...
      (akku lib fetch) (akku lib file-parser) (akku lib git)
      (akku lib graph) (akku lib init) (akku lib install)
      (akku lib library-name) (akku lib lock) (akku lib manifest)
      (akku lib publish) (akku lib r7rs) (akku lib repo-scanner)
      (akku lib scan) (akku lib schemedb) (akku lib scripts)
